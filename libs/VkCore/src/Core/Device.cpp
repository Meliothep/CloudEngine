...
void Device::ConfigureExtentions(bool enableScreen){
    // Extentions 
...
void Device::GetPhysicalDevice(VkInstance instance, VkSurfaceKHR surface, bool enableScreen){
    // Physical device 
...
void Device::GetLogicalDevice(QueueFamilyIndices indices, bool enableScreen){
...
void Device::GetQueue(QueueFamilyIndices indices, bool enableScreen){
    // --- Get queues
...
void Device::Initialize(VkInstance instance, VkSurfaceKHR surface, bool enableScreen){
...
QueueFamilyIndices Device::FindQueueFamilies(VkPhysicalDevice device, VkSurfaceKHR surface, bool enableScreen) {
