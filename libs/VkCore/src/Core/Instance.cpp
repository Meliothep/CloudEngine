...
void Instance::Initialize(bool enableValidationLayers, bool enableScreen){
...
std::vector<const char*> Instance::GetRequiredExtensions(bool enableValidationLayers, bool enableScreen) {
